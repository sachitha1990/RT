<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php echo site_url('home_controller/index');?>" class="logo">
      ...
      <span class="logo-lg"><b>Right</b>Technology</span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs"><?= $user_name['employee_name'];?></span>
            </a>
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  <a href="<?php echo site_url('login_controller/logout');?>" class="btn btn-default btn-flat">Sign out</a>
                </div>
              </li>
            </ul>
          </li>
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        ...
        <div class="pull-left info">
          <p><span class="hidden-xs"><?= $user_name['employee_name'];?></span></p>
          <!-- Status -->
      ...
      <ul class="sidebar-menu">
        <!-- generate menu -->  
        <?php $this->load->view('templates/menu_items'); ?>
  ...
  <div class="content-wrapper">
    ...
    <!-- Main content -->
    <section class="content load_view">
